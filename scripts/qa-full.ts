...
async function main() {
  console.log("1/4 Build de producao");
  runNpmScript("build");

  console.log(`2/4 Subindo servidor temporario em ${baseUrl}`);
  ...
  try {
    ...
    console.log("3/4 Smoke test das rotas criticas");
    runNpmScript("test:smoke", testEnv);

    console.log("4/4 Smoke test do fluxo operacional");
