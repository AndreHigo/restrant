...
Status atual: MVP funcional concluido. Produto final estimado em 73%.
...
- [FAZER] Nivel de aprovacao opcional para cancelamento.
...
Percentual geral estimado para produto final: 73%.
