...
Status atual: MVP funcional concluido. Produto final estimado em 74%.
...
- [AJUSTAR] Expandir bloqueios por modo para futuros canais dedicados de delivery, retirada e balcao.
...
- [AJUSTAR] Expandir aprovacao opcional para cancelamento do pedido completo fora do caixa.
...
Percentual geral estimado para produto final: 74%.
